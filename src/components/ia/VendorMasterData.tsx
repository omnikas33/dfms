...
const VendorMasterData = () => {
  ...
  const [categories, setCategories] = useState<MasterDataItem[]>([
    { id: '1', name: 'Construction', description: 'Construction and Infrastructure', isActive: true },
    { id: '2', name: 'IT Services', description: 'Information Technology Services', isActive: true },
  ...
  const [paymentTerms, setPaymentTerms] = useState<MasterDataItem[]>([
    { id: '1', name: '15 days', description: 'Payment due within 15 days', isActive: true },
    { id: '2', name: '30 days', description: 'Payment due within 30 days', isActive: true },
    { id: '3', name: '45 days', description: 'Payment due within 45 days', isActive: true },
    { id: '4', name: '60 days', description: 'Payment due within 60 days', isActive: true },
    { id: '5', name: '90 days', description: 'Payment due within 90 days', isActive: true }
  ]);
  ...
  const renderMasterDataTable = (
    ...
    <Card>
      <CardHeader>
        ...
        <CardDescription>Manage {title.toLowerCase()} used in vendor management</CardDescription>
      </CardHeader>
    ...
    <div className="space-y-6">
      <Tabs defaultValue="categories" className="w-full">
        ...
        <TabsContent value="payment" className="space-y-4">
          {renderMasterDataTable('Payment Terms', 'payment', paymentTerms, setPaymentTerms)}
        </TabsContent>
